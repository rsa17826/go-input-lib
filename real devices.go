...
// func OpenKeyboardForWrite(path string) (*RealDev, error) {
// 	file, err := os.OpenFile(path, os.O_RDWR, 0600)
// 	if err != nil {
// 		return nil, fmt.Errorf("failed to open device: %w", err)
// 	}
// 	return &RealDev{RealDev{dev: file}}, nil
// }

func (k *RealDev) Close() error {
	return k.dev.Close()
}

// func (k *RealDev) Write(data []byte) (int, error) {
// 	return k.dev.Write(data)
// }

func (k *RealDev) ReadNextInput() (InputEvent, error) {
	var ev InputEvent
	err := binary.Read(k.dev, binary.NativeEndian, &ev)
	return ev, err
}
func (k *RealDev) KeyState(keyCode int) (int, error) {
...
// func (d *RealDev) SendEvent(evType, code uint16, value int32) error {
// 	ev := InputEvent{Type: evType, Code: code, Value: value}
// 	return binary.Write(d.dev, binary.LittleEndian, ev)
// }

// func (d *RealDev) Sync() error {
// 	return d.SendEvent(EV_SYN, 0, 0)
// }

func (k *RealDev) GetPressedKeys() ([]uint16, error) {
